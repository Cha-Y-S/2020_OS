...
if options.solve == False:
    ...
    if policy == 'OPT' or policy == 'RAND' or policy == 'UNOPT' or policy == 'CLOCK':
        leftStr = 'Left '
        riteStr = 'Right'
    else:
    ...
    for nStr in addrList:
        ...
        try:
            if cdebug:
                print 'before idx memory', memory
            idx = memory.index(n)
            hits = hits + 1
            ...
            if count == cachesize:
                ...
                if policy == 'CLOCK':
                    ...
                    while victim == -1:
                        ...
                        if cdebug:
                            print '  Clock Hand (b)', clock_hand
                            print '  scan page(a):', page, ref[page]
                        ...
                        if ref[page] >= 1:
                            ...
                            break
                        if cdebug:
                            print '  scan page(b):', page, ref[page]
